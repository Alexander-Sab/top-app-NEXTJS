...
const ProductComponent = forwardRef<HTMLDivElement, ProductProps>(
	({ product, className, ...props }, ref): JSX.Element => {
		...
		return (
			<div
				className={cn(styles.productWrapper, className)}
				{...props}
				ref={ref}
			>
				<Card className={styles.product}>
					<div className={styles.logo}>
						<Image
							src={product.image}
							alt={product.title}
							width={70} // Задайте фактическую ширину изображения
							height={70} // Задайте фактическую высоту изображения
						/>
					</div>
